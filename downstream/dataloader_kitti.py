...
class SemanticKITTIDataset(Dataset):
    ...
    def __init__(self, phase, config, transforms=None):
        ...
        for num in phase_set:
            directory = next(
                os.walk(
                    f"/mnt/petrelfs/share_data/wuxiaoyang/datasets/raw/SemanticKITTI/dataset/sequences/{num:0>2d}/velodyne"
                    # "/mnt/lustre/zhangsha/dataset/SemanticKITTI/raw/dataset/sequences/{num:0>2d}/velodyne"
                    # "/data/workspace/dataset/semantic_kitti/dataset/sequences/{num:0>2d}/velodyne"
                )
            )
            #/data/workspace/dataset/semantic_kitti/dataset/sequences/00/velodyne
            self.list_files.extend(
                map(
                    lambda x: f"/mnt/petrelfs/share_data/wuxiaoyang/datasets/raw/SemanticKITTI/dataset/sequences/"
